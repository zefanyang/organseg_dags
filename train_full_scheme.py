...
def get_model(args):
    ...
    elif args.net == 'unet_deep_sup_full_scheme_8_neigh':
        model = UNetL9DeepSupFullScheme(1, args.num_class, num_neigh='eight', init_ch=args.init_channels)

    # Ablation Study
    elif args.net == 'unet_deep_sup_full_scheme_no_dags':
    ...
    elif args.net == 'unet_deep_sup_full_scheme_num_escs':
        model = UNetL9DeepSupFullScheme_ESCs(1, args.num_class, no_escs=args.no_escs, init_ch=args.init_channels)
