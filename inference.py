...
parser.add_argument('--net', type=str, default='unet_l9_ds_full_scheme')
...
PARENT_FOLD = 'UNet_9_Layer_Full_Scheme'  # TODO
CHILD_FOLD = f'unet_deep_sup_full_scheme_fold{args.fold}'  # TODO
...
def get_model(args):
    model = None
    if args.net == 'unet_l9_ds_full_scheme':
